...
const areasAndRoles: Record<string, string[]> = {
  "Dirección y Administración": [
    "Director General",
    "Socio",
    "Event Producer Ejecutivo",
    "Gerente de Proyecto",
    "Coordinador Administrativo",
    "Secretario Ejecutivo",
    "Asistente Ejecutivo",
    "Partner Co-Productor de Eventos",
    "Contratista",
  ],
  "Producción de Eventos (Escenario y Técnica)": [
    "Stage Manager",
    "Ingeniero de Sonido",
  ...
  "Seguridad y Salud": [
    ...
    "Manager de Crowd / Control de Multitudes",
    "Jefe de Salud",
    "Médico de Emergencias",
    "Paramédico",
    "Personal de Primeros Auxilios",
  ],
  "Producción Digital / Tecnología": [
    "Frontend Developer",
    "Backend Developer",
    "DevOps Engineer",
    "Mobile Developer",
...
export default function LoginPage() {
  ...
  const [mode, setMode] = useState<"login" | "master-password" | "register">(
    "login",
  );
  ...
  const [jobTitle, setJobTitle] = useState(
    areasAndRoles[Object.keys(areasAndRoles)[0]][0],
  );
  ...
  useEffect(() => {
    if (personType === "Profesional IA" && name) {
      const cleanName = (name + (lastName ? ` ${lastName}` : ""))
        .toLowerCase()
        .replace(/\s+/g, ".")
        .replace(/[^a-z0-9.]/g, "");
    ...
    try {
      const res = await fetch("/api/auth/register-user", {
        ...
        body: JSON.stringify({
          ...
          contractType,
          contractEventId:
            contractType === "Por Evento" ? contractEventId : null,
          avatarUrl,
        }),
      });
  ...
  return (
    <>
      ...
      >
        <div
          style={{ width: "100%", maxWidth: mode === "register" ? 600 : 420 }}
        >
          {/* Logo */}
          ...
          <div className="glass-card" style={{ padding: "var(--space-8)" }}>
            ...
            {mode === "login" && (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  style={{ ...btnStyle, marginTop: "var(--space-2)" }}
                >
            ...
            {mode === "master-password" && (
              ...
              >
                ...
                >
                  Por razones de seguridad, la creación de nuevas cuentas está
                  restringida. Ingrese la contraseña maestra del Director
                  General.
                </p>
                <div>
                  <label
            ...
            {mode === "register" && (
              ...
              >
                ...
                >
                  ...
                  >
                    {avatarUrl ? (
                      ...
                      <span
                        style={{ fontSize: "var(--text-4xl)", opacity: 0.5 }}
                      >
                        📸
                      </span>
                    )}
                ...
                >
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    ...
                    >
                      ...
                      <option value="Otro / Nuevo tipo de rol">
                        Otro / Nuevo tipo de rol...
                      </option>
                    </select>
                  </div>
                  {jobTitle === "Otro / Nuevo tipo de rol" && (
                  ...
                  >
                    ...
                    >
                      <option value="Permanente">
                        Plantilla Permanente (Multi-evento)
                      </option>
                      <option value="Por Evento">
                        Exclusivo por Evento / Proyecto
                      </option>
                    </select>
                        ...
                        >
                          {eventsOptions.length > 0 ? (
                            ...
                            <option value="" disabled>
                              No hay eventos creados. Cree uno primero.
                            </option>
                          )}
                        </select>
                      </div>
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    ...
                    >
                      {personType === "Profesional IA"
                        ? "Identificación del Agente (Auto-Generado)"
                        : "Correo corporativo"}
                    </label>
                    <input
                      type="email"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      placeholder="usuario@eventosprime.com"
                      required
                      style={{
                        ...inputStyle,
                        opacity: personType === "Profesional IA" ? 0.7 : 1,
                      }}
                      readOnly={personType === "Profesional IA"}
                    />
                  </div>
                  <div style={{ gridColumn: "1 / -1" }}>
                    <label
                ...
                <button
                  type="submit"
                  disabled={loading}
                  style={{ ...btnStyle, marginTop: "var(--space-4)" }}
                >
