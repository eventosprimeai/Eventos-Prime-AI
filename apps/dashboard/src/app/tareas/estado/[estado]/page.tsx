  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        const sortedMembers = Object.values(userCounts).sort(
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    >
                      {member.taskCount}{" "}
                      {member.taskCount === 1 ? "tarea" : "tareas"}
                    </span>
                  </div>
                </div>
              </div>
