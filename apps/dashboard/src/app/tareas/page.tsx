            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "var(--space-6)" }}>
                {team.map(member => (
                    <div key={member.id}
                        ...
                        <div style={{ width: 80, height: 80, borderRadius: "50%", background: "var(--color-bg-card)", border: "2px solid var(--color-gold-400)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "var(--text-2xl)", marginBottom: "var(--space-4)", overflow: "hidden" }}>
                            {member.avatarUrl ? (
