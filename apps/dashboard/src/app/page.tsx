      ...
      try {
        ...
        if (res.ok) {
          ...
          const activeEvents = data.filter(
            (e: Event) => e.status !== "CERRADO" && e.status !== "CANCELADO",
          );
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Recibe asistencia inmediata guiada por inteligencia artificial.
              </p>
            </div>
          </div>
          <div
          ...
          >
            <div>
              ...
              <select
                required
                value={consultaEventId}
                onChange={(e) => setConsultaEventId(e.target.value)}
                style={{
                  width: "100%",
                  padding: "var(--space-2) var(--space-3)",
                  background: "var(--color-bg-input)",
            ...
            <div>
              ...
              >
                <textarea
                  ...
                  placeholder="Habla o escribe lo que necesitas saber..."
                  rows={3}
                  style={{
                    width: "100%",
                    padding: "var(--space-2) var(--space-3)",
            ...
            <button
              type="submit"
              disabled={isSavingConsulta || !consultaEventId || !consultaQuery}
              style={{
                padding: "var(--space-3)",
                ...
                fontWeight: 700,
                cursor:
                  isSavingConsulta || !consultaEventId || !consultaQuery
                    ? "not-allowed"
                    : "pointer",
                opacity:
                  isSavingConsulta || !consultaEventId || !consultaQuery
