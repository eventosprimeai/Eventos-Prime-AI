  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Arrastra la imagen para encuadrarla. Usa la rueda del mouse o los
          ...
          >
            <div
              style={{
                position: "absolute",
                top: -4,
                left: `${Math.min(100, Math.max(0, ((scale - VIEWPORT / Math.min(imgNaturalSize.w || 1, imgNaturalSize.h || 1)) / ((VIEWPORT / Math.min(imgNaturalSize.w || 1, imgNaturalSize.h || 1)) * 3)) * 100))}%`,
                width: 12,
                height: 12,
                borderRadius: "50%",
