        ...
        <div style={{ padding: "var(--space-6)", maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div className="glass-card" style={{ padding: "var(--space-12)", textAlign: "center" }}>
                ...
                <p style={{ color: "var(--color-text-muted)", maxWidth: 500, margin: "0 auto", lineHeight: 1.6 }}>
                    La conciliación bancaria con OCR (Google Vision + Gemini AI) está planificada para la Fase 3 del módulo financiero.
                    Incluirá subida de estados de cuenta, extracción automática de líneas y match con transacciones registradas.
                </p>
            </div>
        </div>
    );
