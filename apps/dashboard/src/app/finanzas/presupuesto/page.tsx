    ...
    >
      ...
      {!selectedEvent ? (
        ...
        >
          ...
          >
            Selecciona un evento para ver su presupuesto
          </p>
        </div>
      ) : loading ? (
        <div
            ...
            >
              ...
              <div
                style={{
                  fontSize: "var(--text-xl)",
                  fontWeight: 800,
                  color: totalDiff >= 0 ? "#00e676" : "#ff5252",
                }}
              >
                ...
                <tbody>
                  {budgetLines.map((b) => (
                    ...
                    >
                      ...
                      >
                        {formatCurrency(b.executed)}
                      </td>
                      <td
                        style={{
                          padding: "var(--space-3)",
                          color: b.difference >= 0 ? "#00e676" : "#ff5252",
                          fontWeight: 700,
                          fontSize: "var(--text-sm)",
                        }}
                      >
                    ...
                    >
                      ...
                      >
                        <div style={{ display: "flex", gap: "var(--space-2)" }}>
                          <button
                            onClick={addLine}
                            disabled={saving || !newCategory || !newPlanned}
                            style={{
