        ...
        >
          ...
          <div style={{ overflow: "hidden", width: "100%" }}>
            ...
            {(userPersonType || userCategory) && (
              ...
              >
                {userPersonType}{" "}
                {userCategory && userCategory !== userPersonType
                  ? `• ${userCategory}`
                  : ""}
              </p>
            )}
      ...
      {showSubprofileModal && (
        ...
        >
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  ...
                  boxShadow: "0 0 15px var(--color-gold-400)",
                }}
              ></span>
            </div>
            <h3
            ...
            >
              Para crear un sub-perfil supervisado bajo su jerarquía (ideal para
              personal externo o agencias compartidas), por favor contacte al
              Director General: <br />
              <br />
              <strong
                style={{
            ...
            >
              Indique los datos de su personal (Nombre, Correo de la persona a
              delegar). Nosotros procesaremos y conectaremos este sub-perfil
              internamente lo antes posible.
            </p>
            <button
