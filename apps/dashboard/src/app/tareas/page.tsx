    ...
    <div className="animate-fade-in">
      ...
      >
        <div>
          ...
          >
            Selecciona un miembro del equipo para gestionar sus tareas
            asignadas.
          </p>
        </div>
        <button
      ...
      {showForm && (
        ...
        >
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    border: `1px solid ${isRecording ? "red" : "var(--color-border)"}`,
                    display: "flex",
                    alignItems: "center",
          ...
          >
            ...
            <button
              type="submit"
              disabled={saving || !form.eventId || !form.assigneeId}
              style={{
                padding: "var(--space-2) var(--space-5)",
                ...
                fontWeight: 700,
                cursor:
                  saving || !form.eventId || !form.assigneeId
                    ? "not-allowed"
                    : "pointer",
                opacity: saving || !form.eventId || !form.assigneeId ? 0.7 : 1,
              }}
            >
