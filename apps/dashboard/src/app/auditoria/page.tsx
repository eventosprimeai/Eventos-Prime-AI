...
export default function AuditoriaPage() {
  ...
  if (loading) {
    return (
      <div style={{ textAlign: "center", padding: "var(--space-12)" }}>
        ...
        >
          Accediendo a Bóveda de Seguridad...
        </p>
      </div>
    );
  }
  ...
  return (
    <div
      ...
      style={{ padding: "var(--space-4)", maxWidth: 1000, margin: "0 auto" }}
    >
      <div
        style={{
      ...
      >
        <div>
          ...
          >
            Monitoreo exclusivo de accesos no autorizados y trazabilidad del
            sistema.
          </p>
        </div>
      </div>
      ...
      >
        <button
          ...
          style={{
            ...
            border: `1px solid ${activeTab === "alertas" ? "#ff4444" : "var(--color-border)"}`,
            background:
              activeTab === "alertas"
                ? "rgba(255, 68, 68, 0.1)"
                : "var(--color-bg-elevated)",
            color:
              activeTab === "alertas" ? "#ff4444" : "var(--color-text-muted)",
            fontWeight: 700,
            cursor: "pointer",
            transition: "all 0.2s",
          }}
        ...
        <button
          ...
          style={{
            padding: "var(--space-2) var(--space-6)",
            borderRadius: "var(--radius-lg)",
            border: `1px solid ${activeTab === "logs" ? "var(--color-gold-400)" : "var(--color-border)"}`,
            background:
              activeTab === "logs"
                ? "rgba(250, 204, 21, 0.1)"
                : "var(--color-bg-elevated)",
      ...
      {activeTab === "logs" && (
        <div
          className="glass-card"
          style={{ padding: "var(--space-6)", overflowX: "auto" }}
        >
          <table
            style={{
              width: "100%",
              ...
              {logs.map((log) => (
                ...
                >
                  ...
                  <td
                    style={{
                      padding: "var(--space-3)",
                      color: log.action.includes("DEACTIVATE")
                        ? "#ff4444"
