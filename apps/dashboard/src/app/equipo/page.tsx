...
export default function EquipoPage() {
  ...
  const handleDeactivateToggle = async () => {
    ...
    if (
      !confirm(
        `¿Estás seguro de que quieres ${editingUser.active ? "DESACTIVAR" : "RESTAURAR"} a este usuario?`,
      )
    )
      return;
    setSaving(true);
        ...
        {team.map((member) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              textAlign: "center",
              opacity: member.active === false ? 0.6 : 1,
              filter: member.active === false ? "grayscale(100%)" : "none",
            }}
          >
            <div
              className="coin-flip"
              style={{
                ...
                border: `2px solid ${member.active === false ? "gray" : "var(--color-border-light)"}`,
                display: "flex",
                alignItems: "center",
            ...
            <span
              style={{
                ...
                color:
                  member.active === false ? "gray" : "var(--color-gold-400)",
              ...
              >
                ...
                >
                  {editForm.avatarUrl ? (
                    ...
                    <span style={{ fontSize: "var(--text-4xl)", opacity: 0.5 }}>
                      📸
                    </span>
                  )}
                </div>
                ...
                editingUser.id !== currentUserId && (
                  ...
                  >
                      ...
                      style={{
                        ...
                        background:
                          editingUser.active === false
                            ...
                            : "rgba(255,50,50,0.1)",
                        color:
                          editingUser.active === false ? "#44ff44" : "#ff4444",
                        border: `1px solid ${editingUser.active === false ? "#44ff44" : "#ff4444"}`,
                        borderRadius: "var(--radius-lg)",
                        fontWeight: 700,
                        cursor: "pointer",
                      }}
                    >
                      {editingUser.active === false
                        ? "Restaurar Accesos"
                        : "Desactivar Perfil y Batear Accesos (Soft Delete)"}
                    </button>
                  </div>
                )}
