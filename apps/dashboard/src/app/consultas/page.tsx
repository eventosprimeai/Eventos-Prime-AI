...
const formatMessageText = (text: string) => {
  ...
  const html = text
    ...
    .replace(
      /\*\*(.*?)\*\*/g,
      '<strong style="color: var(--color-text-primary); font-weight: 700;">$1</strong>',
    )
    .replace(/\*(.*?)\*/g, "<em>$1</em>")
    .replace(/\n/g, "<br/>");
  return { __html: html };
    ...
    >
      ...
      >
        <div>
          ...
          >
            Revisa el histórico de tus preguntas, solicitudes e investigaciones
            asistidas por Harold.
          </p>
        </div>
      </div>
        ...
        {tasks.length === 0 ? (
          ...
          >
            ...
            <p style={{ fontSize: "var(--text-xs)", opacity: 0.5 }}>
              Utiliza el botón de Consulta arriba a la derecha para interactuar
              con Harold.
            </p>
          </div>
        ) : (
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        <div>
                          ...
                          >
                            {task.assignee?.name || "Usuario Desconocido"} -{" "}
                            <span
                              style={{
                                fontWeight: 400,
                            ...
                            >
                              {task.assignee?.role || "Cargo Desconocido"}
                            </span>
                          </span>
                          <span
                            style={{
                          ...
                          >
                            {task.title.replace("[CONSULTA]", "").trim() ||
                              "Consulta IA"}
                          </span>
                        </div>
                      </div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    {selectedTask.assignee?.name || "Usuario Desconocido"}{" "}
                    <span
                      style={{
                        fontWeight: 400,
                        fontSize: "var(--text-xs)",
                    ...
                    >
                      - {selectedTask.assignee?.role || "Cargo Desconocido"}
                    </span>
                  </h2>
                  <span
                    style={{
                  ...
                  >
                    {selectedTask.title.replace("[CONSULTA]", "").trim() ||
                      "Consulta IA"}
                  </span>
                </div>
              </div>
                  ...
                  style={{
                    ...
                    cursor:
                      sendingMsg || !newMessage.trim()
                        ? "not-allowed"
                        : "pointer",
                    opacity: sendingMsg || !newMessage.trim() ? 0.6 : 1,
                    transition: "var(--transition-fast)",
                    height: 44,
                  }}
                >
